export const AboutIDE = () => {
  return (
    <>
      <h3>Tooling</h3>
      <p>
        As important as what is visual to the user, is the way in which the
        developer sets up his or her environment to accomplish a project's
        goals. Picking the right tools and technologies not only facilitates a
